# -*- coding: utf-8 -*-
"""
Script de prueba para la categorización de artículos médicos.
Este script utiliza el módulo categorizador para probar la categorización de artículos médicos
...
def probar_categorizacion(titulo, abstract, nombre_prueba):
    ...
    # instanciamos el categorizador definido en el script principal del motor de inferencia y le pasamos titulo y resumen
