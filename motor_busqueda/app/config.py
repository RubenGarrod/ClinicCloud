# -*- coding: utf-8 -*-
"""
Script para la configuración del motor de busqueda
"""
import os
...
class Settings(BaseSettings):
    ...
    SIMILARITY_THRESHOLD: float = float(os.getenv("SIMILARITY_THRESHOLD", "0.1")) #Cambiar para establecer la similitud minima entre el embbeding de la query y el embbeding del documento
