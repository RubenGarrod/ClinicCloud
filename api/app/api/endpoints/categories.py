# -*- coding: utf-8 -*-
"""
Endpoint para manejar las categorías de documentos en la API REST de ClinicCloud.
Este módulo define las rutas y funciones para listar y recuperar categorías de documentos.
"""
