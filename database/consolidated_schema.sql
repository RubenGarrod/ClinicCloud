...
-- =====================================================
-- SCRAPER: Query Tracking System (Migration 011)
-- =====================================================
...
BEGIN
    ...
    RAISE NOTICE '  - resumen (document summaries)';
    RAISE NOTICE '  - pmid_procesado (PMID tracking)';
    RAISE NOTICE '  - query_tracking (scraper query tracking)';
    RAISE NOTICE '  - categoria_coverage (category coverage stats)';
    ...
    RAISE NOTICE '  - auth.active_sessions (active sessions)';
