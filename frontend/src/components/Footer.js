      ...
      <div className="footer-container">
        <div className="footer-section footer-logo-section">
          ...
          <p className="footer-tagline">
            Democratizando el acceso<br></br> a la información médica
          </p>
        </div>
        ...
        <div className="footer-section footer-links">
          ...
          <ul>
            ...
            <li><a href="https://github.com/RubenGarrod/ClinicCloud" target="_blank" rel="noopener noreferrer">GitHub</a></li>
          </ul>
        </div>
        ...
        <div className="footer-section footer-contact">
          ...
          <ul>
            ...
            <li><a href="https://github.com/RubenGarrod/ClinicCloud/issues" target="_blank" rel="noopener noreferrer">Reportar un problema</a></li>
          </ul>
        </div>
      </div>
